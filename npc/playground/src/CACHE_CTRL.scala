...
class CACHE_CTRL extends Module
{
    val io = IO(new Bundle
    {
        ...
        val cpu_enw = Input(Bool())
        val cpu_wmask = Input(UInt(8.W))
        ...
        val wmask2mem = Output(UInt(8.W))
        val valid2mem = Output(Bool())
        val enw2mem = Output(Bool())
        ...
        val wdata2cache = Output(UInt(128.W))
